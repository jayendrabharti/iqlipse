      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-textColor3">
            Be part of something amazing! Join our community of passionate
            individuals.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <Reveal
            type="leftRight"
            className="p-6 shadow-custom dark:bg-backgroundColor2 rounded-lg"
          >
            <h3 className="text-xl font-semibold mb-2">Learn & Grow</h3>
            <p className="text-textColor3">
              Access workshops, resources, and mentorship opportunities
            </p>
          </Reveal>
          ...
          >
            ...
            <p className="text-textColor3">
              Participate in exclusive events, competitions, and social
              gatherings
            </p>
          </Reveal>
        </div>
        ...
        <Reveal delay={0.5}>
          ...
          <div className="shadow-custom dark:bg-backgroundColor2 rounded-lg p-8 text-center">
            ...
            <p className="text-textColor3 mb-6">
              Click below to fill out our registration form
            </p>
            <a
