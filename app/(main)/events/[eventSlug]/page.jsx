  ...
  return (
    <>
      ...
      <div className={`grid xl:grid-cols-[auto_1fr_auto] xl:grid-rows-[auto] md:grid-cols-[auto_1fr] md:grid-rows-[auto_1fr] grid-cols-[auto] grid-rows-[auto_auto_auto] content-start`}>
        ...
        {/* Buttons */}
        <div className='border border-borderColor3 p-3 flex flex-col space-y-2 h-min m-3 rounded-lg min-w-[300px] mx-auto md:col-start-1 md:col-end-2 md:row-start-2 md:row-end-3 xl:col-start-3 xl:col-end-4 xl:row-start-1 xl:row-end-2 bg-backgroundColor1'>
          <button
